    ...
    <div>
      ...
      <div className="flex flex-col gap-16 my-10 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 text-gray-600 md:w-2/4">
          <p>
            Chào mừng bạn đến với Trendify – nơi phong cách gặp gỡ chất lượng.
            ...
            hiện cá tính thông qua thời trang – và Trendify sẽ giúp bạn làm điều
            đó dễ dàng và thú vị hơn.
          </p>
          <p>
            Tại Trendify, sự hài lòng của bạn là ưu tiên hàng đầu. Từ lúc bạn
            ...
            Trendify – rất vinh dự khi được đồng hành cùng phong cách của bạn.
          </p>

          <b className="text-gray-800">Sứ mệnh của chúng tôi</b>
          <p>
            Trendify mong muốn truyền cảm hứng để bạn thể hiện phong cách riêng
          ...
          <p>
            Trendify hướng tới trở thành thương hiệu thời trang hàng đầu toàn
      ...
      <div className="flex flex-col mb-20 text-sm md:flex-row">
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            Tại Trendify, chất lượng là trên hết. Mỗi sản phẩm đều được chọn lọc
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            Trendify mang đến trải nghiệm mua sắm mượt mà với giao diện thân
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            Trendify luôn cam kết mang đến dịch vụ tốt nhất. Đội ngũ hỗ trợ tận
